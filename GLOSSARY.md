...
Short definitions for the encyclopedia. These are intentionally practical
...
| Carrier | The physical medium or phenomenon carrying information. |
| Cathode | Electron-emitting source in a CRT. |
...
| Feature code | Representation using edges, motion, contrast, color, depth, or shape instead of pixels. |
| Frontier concept | Far-future or not-yet-demonstrated idea preserved for hypothesis building and conceptual mapping. |
...
| Receptive field | Region of sensory space that affects a neuron or cell. |
| Retina | Neural tissue at the back of the eye that detects and preprocesses light. |
| Retinal prosthesis | Device that stimulates retinal tissue to produce useful visual percepts. |
| Retinotopy | Spatial mapping where neighboring visual-field points map to neighboring neural tissue. |
| Rod | Highly light-sensitive photoreceptor important for low-light vision. |
| Semantic cue | Meaning-level information, such as "door ahead" or "person right." |
| Sensory substitution | Translating information from one sense into another, such as vision into touch. |
