...
The current README uses remote images that were present in the shared ChatGPT
conversation. They are useful as temporary references, but a public repository
should replace them with original diagrams or images with confirmed licenses.
...
| Plausibility ladder | Show established display science through the memory frontier. |
...
- Mark established, research, prototype, speculative, and frontier concepts
